...
const translations = {
    fr: {
        ...
        time_ceremony: "14h00",
        time_reception: "17h00",
        ceremony: "Cérémonie",
        geghard: "Monastère de Geghard<br>",
        reception: "Réception",
        astafyan: "Astafyan Hall Restaurant Complex<br>Jrvej",
        btn_map: "Itinéraire",
        btn_yandex: "🚕 Yandex Go",
        btn_gg: "🚕 ggTaxi",
    ...
    hy: {
        ...
        astafyan: "Աստաֆյան Հոլ Ռեստորանային Համալիր<br>Ջրվեժ",
        btn_map: "Երթուղի",
        btn_yandex: "🚕 Yandex Go",
        btn_gg: "🚕 ggTaxi",
...
const langFlags = { 
    fr: '<img src="https://flagcdn.com/w20/fr.png" alt="FR" class="flag-icon"><span class="lang-text">FR</span>', 
    hy: '<img src="https://flagcdn.com/w20/am.png" alt="AM" class="flag-icon"><span class="lang-text">HY</span>', 
    ru: '<img src="https://flagcdn.com/w20/ru.png" alt="RU" class="flag-icon"><span class="lang-text">RU</span>' 
};
